    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-muted-foreground mt-2">
          Comparativa de índices de seguridad entre comunas de Chile.
        </p>
      </motion.div>
                    ...
                    <tr key={item.comuna.id} className="hover:bg-muted/30">
                      ...
                      <td className="px-4 py-4 text-center">
                        <span className={`
                          ...
                          ${(item.indices.global || 0) >= 70 ? 'bg-green-500/10 text-green-500' :
                            (item.indices.global || 0) >= 50 ? 'bg-yellow-500/10 text-yellow-500' :
                      ...
                      <td className="px-4 py-4 text-center text-muted-foreground">
                        {item.tasas.delictual?.toFixed(1) || 'N/A'}
                      </td>
                      <td className="px-4 py-4 text-center">
